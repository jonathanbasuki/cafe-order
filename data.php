...
$user3 = new User('Emily', 'female');
$user4 = new User('Chris', 'male');

$users = array($user1, $user2, $user3, $user4);

$review1 = new Review($juice->getName(), $user1->getId(), 'Yummy');
$review2 = new Review($curry->getName(), $user1->getId(), 'Very healthy');
$review3 = new Review($coffee->getName(), $user2->getId(), 'Smells good');
$review4 = new Review($pasta->getName(), $user2->getId(), 'The sauce is good :)');
$review5 = new Review($juice->getName(), $user3->getId(), 'Just a plain orange juice');
$review6 = new Review($curry->getName(), $user3->getId(), 'Good price');
$review7 = new Review($coffee->getName(), $user4->getId(), 'The bitterness is enough.');
$review8 = new Review($pasta->getName(), $user4->getId(), 'Quality materials used.');
